(function (window, document, $, undefined) {
    ...
    let lekhaporaJs = {
        ...
        methods: function (e) {
            lekhaporaJs.salActive();
            lekhaporaJs.magnigyPopup();
            lekhaporaJs.slickSlider();
            lekhaporaJs.headerSticky();
            lekhaporaJs.counterUp();
            lekhaporaJs.productHoverTilt();
            lekhaporaJs.masonryActivation();
            lekhaporaJs.lightboxActivation();
            lekhaporaJs.boxHover();
            lekhaporaJs.boxHoverSlider();
            lekhaporaJs.pricingPlan();
            lekhaporaJs.wowActivation();
            lekhaporaJs.qtyBtn();
            lekhaporaJs.accordionBtnTwo();
            lekhaporaJs.bannerAnimation();
            lekhaporaJs.popupMobileMenu();
            lekhaporaJs.searchPopup();
            lekhaporaJs.bgMarque();
            lekhaporaJs.filterClickButton();
            lekhaporaJs.contactForm();
        },
        ...
        slickSlider: function () {
            ...
            $('.lekhapora-home-five-testimonial-activation').slick({
                dots: true,
                infinite: true,
                arrows: false,
                speed: 500,
            ...
            $('.lekhapora-course-details-related-course-carousel').slick({
                dots: false,
                infinite: true,
                arrows: false,
                speed: 1000,
            ...
            $('.lekhapora-course-carousel-page-with-dots').slick({
                dots: true,
                infinite: true,
                arrows: false,
                speed: 1000,
            ...
            $('.lekhapora-event-one-carousel-wrapper').slick({
                dots: true,
                infinite: true,
                arrows: false,
                speed: 1000,
        ...
        productHoverTilt: function () {
            if ( $.isFunction( $.fn.tilt ) ) {
                $( '.lekhapora-single-product-thumb-wrapper' ).tilt( {
                    maxTilt: 30,
                    perspective: 1000,
        ...
        boxHover: function(){
            jQuery( '.edu-instructor-3-visible, .lekhapora-hover-item-visible' ).on( 'mouseenter', function(){
                let selector = jQuery(this).parent().parent();
                selector.find( '.edu-instructor-3-visible, .lekhapora-hover-item-visible' ).removeClass( 'lekhapora-hover-active' );
                jQuery(this).addClass( 'lekhapora-hover-active' );
            });
        },
        ...
        boxHoverSlider: function(){
            jQuery( '.edu-instructor-3-slider-visible' ).on( 'mouseenter', function(){
                ...
                selector.find( '.edu-instructor-3-slider-visible' ).removeClass( 'lekhapora-hover-active' );
                jQuery(this).addClass( 'lekhapora-hover-active' );
            });
        },
        ...
        searchPopup: function () {
            ...
            $('.edu-search-popup .lekhapora-search-popup-field').on('click', function (e) {
                e.stopPropagation();
            })
        },
