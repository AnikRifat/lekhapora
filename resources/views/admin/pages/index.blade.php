...
<html lang="en">
    ...
    <body class="hold-transition light-skin sidebar-mini theme-primary fixed">
                ...
                <div class="d-flex align-items-center logo-box justify-content-start">
                    ...
                    <a href="index.html" class="logo">
                        ...
                        <div class="logo-mini w-30">
                            <span class="light-logo"><img src="{{ asset('/assets/admin') }}/images/logo-letter.png"
                                  alt="logo"></span>
                            <span class="dark-logo"><img src="{{ asset('/assets/admin') }}/images/logo-letter-white.png"
                                  alt="logo"></span>
                        </div>
                        <div class="logo-lg">
                            <span class="light-logo"><img src="{{ asset('/assets/admin') }}/images/logo-dark-text.png"
                                  alt="logo"></span>
                            <span class="dark-logo"><img src="{{ asset('/assets/admin') }}/images/logo-light-text.png"
                                  alt="logo"></span>
                        </div>
                    </a>
                </div>
                    ...
                    <div class="navbar-custom-menu r-side">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown notifications-menu btn-group">
                                <a href="#"
                                  class="waves-effect waves-light btn-primary-light svg-bt-icon bg-transparent"
                            ...
                            <li class="btn-group d-xl-inline-flex d-none">
                                <a href="#"
                                  ...
                                  data-bs-toggle="dropdown">
                                    <img class="rounded-circle"
                                      src="http://edulearn-lms-admin-template.multipurposethemes.com/images/svg-icon/usa.svg"
                                      alt="">
                                </a>
                                <div class="dropdown-menu">
                                    <a class="dropdown-item my-5" href="#"><img class="w-20 rounded me-10"
                                          ...
                                          alt=""> English</a>
                                    <a class="dropdown-item my-5" href="#"><img class="w-20 rounded me-10"
                                          src="http://edulearn-lms-admin-template.multipurposethemes.com/images/svg-icon/spain.svg"
                                          alt=""> Spanish</a>
                                    <a class="dropdown-item my-5" href="#"><img class="w-20 rounded me-10"
                                          src="http://edulearn-lms-admin-template.multipurposethemes.com/images/svg-icon/ger.svg"
                                          alt=""> German</a>
                                    <a class="dropdown-item my-5" href="#"><img class="w-20 rounded me-10"
                                          src="http://edulearn-lms-admin-template.multipurposethemes.com/images/svg-icon/jap.svg"
                                          alt=""> Japanese</a>
                                    <a class="dropdown-item my-5" href="#"><img class="w-20 rounded me-10"
                                          src="http://edulearn-lms-admin-template.multipurposethemes.com/images/svg-icon/fra.svg"
                                          alt=""> French</a>
                                </div>
                            </li>
                                ...
                                <a href="#"
                                  ...
                                  title="User" data-bs-toggle="modal" data-bs-target="#quick_user_toggle">
                                    <div class="d-flex pt-1 align-items-center">
                                        ...
                                        <img src="{{ asset('/assets/admin') }}/images/avatar/avatar-13.png"
                    ...
                    <div class="multinav">
                        <div class="multinav-scroll" style="height: 97%;">
                            ...
                            <ul class="sidebar-menu" data-widget="tree">
                                ...
                                <li>
                                    <a href="extra_calendar.html"><i
                                          data-feather="command"></i><span>Calendar</span></a>
                                </li>
                                <li>
                                    <a href="contact_app_chat.html"><i data-feather="message-circle"></i><span>Group
                                            chats</span></a>
                                </li>
                                ...
                                <li class="treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        <li class="treeview">
                                            ...
                                            <ul class="treeview-menu">
                                                <li><a href="component_bootstrap_switch.html"><i
                                            ...
                                            <ul class="treeview-menu">
                                                ...
                                                <li class="treeview">
                                                    ...
                                                    <ul class="treeview-menu">
                                                        ...
                                                        <li><a href="charts_echarts_bar.html"><i
                                                                  class="icon-Commit"><span class="path1"></span><span
                                                                      class="path2"></span></i>Bar Chart</a></li>
                                            ...
                                            <ul class="treeview-menu">
                                                <li class="treeview">
                                                    ...
                                                    <ul class="treeview-menu">
                                                        ...
                                                        <li><a href="widgets_statistic.html"><i
                                                                  class="icon-Commit"><span class="path1"></span><span
                                        ...
                                        <div class="box-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex flex-column fw-500">
                                                        <a href="course.html"
                                                          class="text-dark hover-success mb-1 fs-16">Web Dev.</a>
                                                        <span class="text-fade">30+ Courses</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="d-flex align-items-center">
                                                    <div class="me-15 mb-1">
                                                        <img
                                                          src="{{ asset('/assets/admin') }}/images/avatar/avatar-1.png"
                                        ...
                                        <div class="box-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="d-flex align-items-center">
                                                    <div class="me-15 mb-1">
                                                        <img
                                                          src="{{ asset('/assets/admin') }}/images/avatar/avatar-2.png"
                                                          class="bg-primary-light avatar avatar-lg rounded-circle"
                                                          alt="">
                                                    </div>
                                                    <div class="d-flex flex-column fw-500">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="d-flex align-items-center">
                                                    <div class="me-15" style="margin-bottom: 1px;">
                                                        <img
                                                          src="{{ asset('/assets/admin') }}/images/avatar/avatar-3.png"
                                                          class="bg-primary-light avatar avatar-lg rounded-circle"
                                                          alt="">
                                                    </div>
                                                    <div class="d-flex flex-column fw-500">
                                        ...
                                        <div class="box-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="d-flex align-items-center">
                                                    <div class="me-15">
                                                        <img
                                                          src="{{ asset('/assets/admin') }}/images/avatar/avatar-4.png"
                                                          class="bg-primary-light avatar avatar-lg rounded-circle"
                                                          alt="">
                                                    </div>
                                                    <div class="d-flex flex-column fw-500">
                                        ...
                                        <div class="box mb-15 pull-up">
                                            <div class="box-body">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div class="d-flex align-items-center">
                                                        <div
                                                          class="me-15 bg-warning h-50 w-50 l-h-68 rounded text-center">
                                        ...
                                        <div class="box mb-15 pull-up">
                                            <div class="box-body">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div class="d-flex align-items-center">
                                                        <div
                                                          class="me-15 bg-primary h-50 w-50 l-h-68 rounded text-center">
                                        ...
                                        <div class="box mb-15 pull-up">
                                            <div class="box-body">
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <div class="d-flex align-items-center">
                                                        <div
                                                          class="me-15 bg-danger h-50 w-50 l-h-68 rounded text-center">
                                                            <span class="icon-Book-open fs-24"><span
                                                                  class="path1"></span><span
                                                                  class="path2"></span></span>
                                                        </div>
                            ...
                            <div class="col-xl-4 col-12">
                                <div class="box">
                                                ...
                                                <div class="media bar-0">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <p class="text-fade">It is a long established fact that a reader
                                                            will be<span class="d-xxxl-inline-block d-none"> distracted
                                                                by the readable</span>...</p>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="box-footer text-center p-20">
                                        <a href="extra_taskboard.html" class="btn w-p100 btn-primary-light p-5">View
                                            all</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-body p-30 bg-white">
                            ...
                            <div>
                                <div class="d-flex flex-row">
                                    <div class=""><img src="{{ asset('/assets/admin') }}/images/avatar/avatar-13.png"
        ...
        <script src="{{ asset('/assets/admin') }}/vendor_components/apexcharts-bundle/dist/apexcharts.js">
        </script>
        <script src="{{ asset('/assets/admin') }}/vendor_components/moment/min/moment.min.js"></script>
        <script src="{{ asset('/assets/admin') }}/vendor_components/bootstrap-daterangepicker/daterangepicker.js">
        </script>
