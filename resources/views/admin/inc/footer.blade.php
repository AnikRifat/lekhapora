            ...
            <div class="row">
                <div class="col-lg-3 col-12">
                    <div class="widget">
                        ...
                        <p class="text-capitalize mb-20">Lorem ipsum dolor sit amet, consectetur adipiscing
                            elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
                            minim veniam, quis exercitation ullamco laboris<br><br>Duis aute irure dolor in
                ...
                <div class="col-lg-3 col-12">
                    <div class="widget">
                        ...
                        <ul class="list list-unstyled mb-30">
                            ...
                            <li> <i class="fa fa-envelope"></i> <span>info@EduLearn.com
                                </span><br><span>support@EduLearn.com </span></li>
                        </ul>
                    </div>
                </div>
                <div class="col-12 col-lg-3">
                    <div class="widget widget_gallery clearfix">
                        ...
                        <ul class="list-unstyled">
                            <li><img src="assets/client/images//gallery/thumb/1.jpg" alt=""></li>
                            <li><img src="assets/client/images//gallery/thumb/2.jpg" alt=""></li>
                            <li><img src="assets/client/images//gallery/thumb/3.jpg" alt=""></li>
                            <li><img src="assets/client/images//gallery/thumb/4.jpg" alt=""></li>
                            <li><img src="assets/client/images//gallery/thumb/5.jpg" alt=""></li>
                            <li><img src="assets/client/images//gallery/thumb/6.jpg" alt=""></li>
                            <li><img src="assets/client/images//gallery/thumb/7.jpg" alt=""></li>
                            <li><img src="assets/client/images//gallery/thumb/8.jpg" alt=""></li>
                            <li><img src="assets/client/images//gallery/thumb/9.jpg" alt=""></li>
                            <li><img src="assets/client/images//gallery/thumb/10.jpg" alt=""></li>
                            <li><img src="assets/client/images//gallery/thumb/11.jpg" alt=""></li>
                            <li><img src="assets/client/images//gallery/thumb/12.jpg" alt=""></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-12">
